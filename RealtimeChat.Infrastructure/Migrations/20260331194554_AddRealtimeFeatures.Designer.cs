...
namespace RealtimeChat.Infrastructure.Migrations
{
    ...
    [Migration("20260331194554_AddRealtimeFeatures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.ChatRoomMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.ChatRoom", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("RealtimeChat.Domain.Entities.ChatRoomMember", b =>
                {
                    b.HasOne("RealtimeChat.Domain.Entities.ChatRoom", "Room")
                        .WithMany("Members")
